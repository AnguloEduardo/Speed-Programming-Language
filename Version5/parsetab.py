...
_lr_productions = [
  ...
  ('DCLCUBE1 -> LBRACKET IDENTIFICATOR1 RBRACKET LBRACKET IDENTIFICATOR1 RBRACKET LBRACKET IDENTIFICATOR1 RBRACKET','DCLCUBE1',9,'p_DCLCUBE_EJECUCION','syntactic_analyser.py',314),
  ('IDENTIFICATOR1 -> NUMBER','IDENTIFICATOR1',1,'p_IDENTIFICATOR_EJECUCION','syntactic_analyser.py',320),
  ('IDENTIFICATOR1 -> ID','IDENTIFICATOR1',1,'p_IDENTIFICATOR_1_EJECUCION','syntactic_analyser.py',326),
  ('VAR -> ID','VAR',1,'p_STATEMENTS_VAR','syntactic_analyser.py',332),
  ('VAR -> ID PUSH DCLARRAY1','VAR',3,'p_STATEMENTS_VAR1','syntactic_analyser.py',338),
  ('VAR -> ID PUSH DCLMATRIX1','VAR',3,'p_STATEMENTS_VAR1','syntactic_analyser.py',339),
  ('VAR -> ID PUSH DCLCUBE1','VAR',3,'p_STATEMENTS_VAR1','syntactic_analyser.py',340),
  ('PUSH -> <empty>','PUSH',0,'p_PUSH','syntactic_analyser.py',345),
  ('ELSE1 -> ELSE','ELSE1',1,'p_STATEMENTS_IF_ELSE1','syntactic_analyser.py',351),
  ('ELSE1 -> <empty>','ELSE1',0,'p_STATEMENTS_IF_ELSE1_EMPTY','syntactic_analyser.py',357),
  ('THEN1 -> THEN','THEN1',1,'p_STATEMENTS_IF_THEN1','syntactic_analyser.py',362),
  ('WHILE1 -> WHILE','WHILE1',1,'p_STATEMENTS_WHILE_WHILE1','syntactic_analyser.py',368),
  ('DO1 -> DO','DO1',1,'p_STATEMENTS_WHILE_DO1','syntactic_analyser.py',374),
  ('DO2 -> DO','DO2',1,'p_STATEMENTS_DO_DO2','syntactic_analyser.py',380),
  ('ID1 -> ID','ID1',1,'p_STATEMENTS_FOR_ID','syntactic_analyser.py',386),
  ('TO1 -> TO','TO1',1,'p_STATEMENTS_FOR_TO','syntactic_analyser.py',392),
  ('DO3 -> DO','DO3',1,'p_STATEMENTS_FOR_DO','syntactic_analyser.py',398),
  ('VALUE -> LPARENT VAR RPARENT','VALUE',3,'p_VALUE','syntactic_analyser.py',404),
  ('VALUE -> TEXT','VALUE',1,'p_VALUE1','syntactic_analyser.py',410),
  ('TEXT -> LPARENT STRING RPARENT','TEXT',3,'p_TEXT','syntactic_analyser.py',416),
  ('TEXT -> <empty>','TEXT',0,'p_TEXT1','syntactic_analyser.py',422),
]
