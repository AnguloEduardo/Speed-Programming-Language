...
_lr_productions = [
  ...
  ('program -> PROGRAM ID V SP X END','program',6,'p_PROGRAM','syntactic_analyser.py',20),
  ('V -> DIM IDLIST AS TIPO SEMMICOLON V','V',6,'p_V','syntactic_analyser.py',25),
  ('V -> <empty>','V',0,'p_V','syntactic_analyser.py',26),
  ('IDLIST -> ID','IDLIST',1,'p_IDLIST','syntactic_analyser.py',31),
  ('IDLIST -> IDLIST COMMA ID','IDLIST',3,'p_IDLIST','syntactic_analyser.py',32),
  ('IDLIST -> <empty>','IDLIST',0,'p_IDLIST','syntactic_analyser.py',33),
  ('TIPO -> WORD','TIPO',1,'p_TIPO','syntactic_analyser.py',38),
  ('TIPO -> FLOAT','TIPO',1,'p_TIPO','syntactic_analyser.py',39),
  ('TIPO -> ARRAY LBRACKET E RBRACKET','TIPO',4,'p_TIPO','syntactic_analyser.py',40),
  ('TIPO -> MATRIX LBRACKET E RBRACKET LBRACKET E RBRACKET','TIPO',7,'p_TIPO','syntactic_analyser.py',41),
  ('TIPO -> CUBE LBRACKET E RBRACKET LBRACKET E RBRACKET LBRACKET E RBRACKET','TIPO',10,'p_TIPO','syntactic_analyser.py',42),
  ('SP -> SUBPROCEDURE ID V X ENDSUB SEMMICOLON SP','SP',7,'p_SP','syntactic_analyser.py',47),
  ('SP -> <empty>','SP',0,'p_SP','syntactic_analyser.py',48),
  ('X -> S SEMMICOLON X','X',3,'p_X','syntactic_analyser.py',52),
  ('X -> <empty>','X',0,'p_X','syntactic_analyser.py',53),
  ('S -> LET E ASSIGN E','S',4,'p_S','syntactic_analyser.py',58),
  ('S -> PRINT Q','S',2,'p_S','syntactic_analyser.py',59),
  ('S -> INPUT TEXT GTGT U','S',4,'p_S','syntactic_analyser.py',60),
  ('S -> CLS','S',1,'p_S','syntactic_analyser.py',61),
  ('S -> IF EL THEN X ELSE1 ENDIF','S',6,'p_S','syntactic_analyser.py',62),
  ('S -> WHILE EL X WHEND','S',4,'p_S','syntactic_analyser.py',63),
  ('S -> DO X LOOPUNTIL EL ENDO','S',5,'p_S','syntactic_analyser.py',64),
  ('S -> FOR O TO E X NEXT','S',6,'p_S','syntactic_analyser.py',65),
  ('S -> GOSUB ID','S',2,'p_S','syntactic_analyser.py',66),
  ('O -> E','O',1,'p_O','syntactic_analyser.py',71),
  ('O -> E ASSIGN E','O',3,'p_O','syntactic_analyser.py',72),
  ('U -> ID','U',1,'p_U','syntactic_analyser.py',77),
  ('U -> ID LBRACKET E RBRACKET','U',4,'p_U','syntactic_analyser.py',78),
  ('U -> ID LBRACKET E RBRACKET LBRACKET E RBRACKET','U',7,'p_U','syntactic_analyser.py',79),
  ('U -> ID LBRACKET E RBRACKET LBRACKET E RBRACKET LBRACKET E RBRACKET','U',10,'p_U','syntactic_analyser.py',80),
  ('Q -> LPARENT U RPARENT','Q',3,'p_Q','syntactic_analyser.py',85),
  ('Q -> TEXT','Q',1,'p_Q','syntactic_analyser.py',86),
  ('TEXT -> LPARENT STRING H RPARENT','TEXT',4,'p_TEXT','syntactic_analyser.py',91),
  ('TEXT -> <empty>','TEXT',0,'p_TEXT','syntactic_analyser.py',92),
  ('H -> PLUS STRING H','H',3,'p_H','syntactic_analyser.py',97),
  ('H -> PLUS U H','H',3,'p_H','syntactic_analyser.py',98),
  ('H -> <empty>','H',0,'p_H','syntactic_analyser.py',99),
  ('ELSE1 -> ELSE X','ELSE1',2,'p_ELSE1','syntactic_analyser.py',104),
  ('ELSE1 -> <empty>','ELSE1',0,'p_ELSE1','syntactic_analyser.py',105),
  ('E -> E PLUS T','E',3,'p_E','syntactic_analyser.py',110),
  ('E -> E MINUS T','E',3,'p_E','syntactic_analyser.py',111),
  ('E -> T','E',1,'p_E','syntactic_analyser.py',112),
  ('T -> T TIMES F','T',3,'p_T','syntactic_analyser.py',117),
  ('T -> T DIVIDE F','T',3,'p_T','syntactic_analyser.py',118),
  ('T -> F','T',1,'p_T','syntactic_analyser.py',119),
  ('F -> NUMBER','F',1,'p_F','syntactic_analyser.py',124),
  ('F -> U','F',1,'p_F','syntactic_analyser.py',125),
  ('F -> LPARENT E RPARENT','F',3,'p_F','syntactic_analyser.py',126),
  ('EL -> EL OR TL','EL',3,'p_EL','syntactic_analyser.py',131),
  ('EL -> NOT TL','EL',2,'p_EL','syntactic_analyser.py',132),
  ('EL -> TL','EL',1,'p_EL','syntactic_analyser.py',133),
  ('TL -> TL AND FL','TL',3,'p_TL','syntactic_analyser.py',138),
  ('TL -> FL','TL',1,'p_TL','syntactic_analyser.py',139),
  ('FL -> K OPREL K','FL',3,'p_FL','syntactic_analyser.py',144),
  ('FL -> LPARENT EL RPARENT','FL',3,'p_FL','syntactic_analyser.py',145),
  ('OPREL -> LT','OPREL',1,'p_OPREL','syntactic_analyser.py',150),
  ('OPREL -> LTE','OPREL',1,'p_OPREL','syntactic_analyser.py',151),
  ('OPREL -> GT','OPREL',1,'p_OPREL','syntactic_analyser.py',152),
  ('OPREL -> GTE','OPREL',1,'p_OPREL','syntactic_analyser.py',153),
  ('OPREL -> NE','OPREL',1,'p_OPREL','syntactic_analyser.py',154),
  ('OPREL -> EQUAL','OPREL',1,'p_OPREL','syntactic_analyser.py',155),
  ('K -> ID','K',1,'p_K','syntactic_analyser.py',160),
  ('K -> NUMBER','K',1,'p_K','syntactic_analyser.py',161),
]
